<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="HistoricoPagosPorMes.aspx.cs" Inherits="HistoricoPagosPorMes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <td class="auto-style11">
                        <asp:Label ID="labMesInicio" runat="server" Font-Bold="True" Font-Names="Miriam" ForeColor="#193C75" Text="MES INICIO REPORTE"></asp:Label>                                                
                    </td>
        <td class="auto-style4" align="center">
            <asp:DropDownList ID="ddlMesInicio" Height="20px" Width="120px" runat="server"></asp:DropDownList>
        </td>
    <td class="auto-style11">
                        <asp:Label ID="labAnioInicio" runat="server" Font-Bold="True" Font-Names="Miriam" ForeColor="#193C75" Text="AÑO INICIO REPORTE"></asp:Label>                                                
                    </td>
        <td class="auto-style4" align="center">
    ...
    <td class="auto-style12">
                        <asp:Label ID="labMesFin" runat="server" Font-Bold="True" Font-Names="Miriam" ForeColor="#193C75" Text="MES FIN REPORTE"></asp:Label>
                        </td>
        <td align="center" class="auto-style16">
                        <asp:DropDownList ID="ddlMesFin" Height="20px" Width="120px" runat="server"></asp:DropDownList>
        </td>
        <td class="auto-style12">
                        <asp:Label ID="labAnioFin" runat="server" Font-Bold="True" Font-Names="Miriam" ForeColor="#193C75" Text="AÑO FIN REPORTE"></asp:Label>                        
                        </td>
            <td align="center" class="auto-style16">
                        <asp:DropDownList ID="ddlAnioFin" Height="20px" Width="120px" runat="server"></asp:DropDownList>
                    </td>                  
        <td></td>
